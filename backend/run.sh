...
# install core and development Python dependencies into a new venv when pyproject.toml is at root
...
function test:ci {
    INSTALLED_PKG_DIR="$(python -c 'import backend; print(backend.__path__[0])')"
